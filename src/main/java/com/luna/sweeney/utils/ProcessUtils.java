package com.luna.sweeney.utils;
...
import com.luna.sweeney.exception.constant.BizResultCode;
...
public class ProcessUtils {
    ...
    public static void osKill(int processId) {
        ...
        throw new BaseException(BizResultCode.NOT_SUPPORT, BizResultCode.MSG_NOT_SUPPORT);
    }
